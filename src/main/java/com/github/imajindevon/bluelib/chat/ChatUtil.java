...
public final class ChatUtil {
    ...
    /**
     * Translate the color codes within the given message. Returns an {@link ArrayList} of the translated strings. The
     * returned strings will never be null, but instead empty. If {@code messages} is not null, the type and mutability
     * of the {@link List} will be unknown.
     *
    ...
    /**
     * Translate the strings contained in the provided array. The returned array may contain null strings.
     *
     * @param messages the messages to translate, or null
     *
